...
public class RemoveBookFromCatalogActivity {
    ...
    public RemoveBookFromCatalogResponse execute(RemoveBookFromCatalogRequest removeBookFromCatalogRequest) {
        ...
        CatalogItemVersion deletedVersion = catalogDao.removeBookFromCatalog(removeBookFromCatalogRequest.getBookId());

        return new RemoveBookFromCatalogResponse(CatalogItemConverter.toBook(deletedVersion));
    }
}
